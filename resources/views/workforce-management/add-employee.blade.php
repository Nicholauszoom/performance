...
@section('content')
    ...
    <form method="POST" id="addEmployee" enctype="multipart/form-data" autocomplete="off">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="firstName" name="fname" value="{{ old('fname') }}"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="middleName" name="mname" value="{{ old('mname') }}"
                                class="form-control @error('mname') is-invalid @enderror" placeholder="Middle Name">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select @error('nationality') is-invalid @enderror"
                                name="nationality">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="emp_id" value="{{ old('emp_id') }}"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select @error('department') is-invalid @enderror" id="department"
                                name="department">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select1_single select @error('position') is-invalid @enderror"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select @error('linemanager') is-invalid @enderror"
                                id="linemanager" name="linemanager">
                                <option selected disabled> Select </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select @error('branch') is-invalid @enderror" name="branch"
                                required>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select @error('pension_fund') is-invalid @enderror"
                                name="pension_fund">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" maxlength="30" name="pf_membership_no"
                                value="{{ old('pf_membership_no') }}"
                                class="form-control @error('pf_membership_no') is-invalid @enderror"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="emp_code" maxlength="30"
                                class="form-control @error('emp_code') is-invalid @enderror" placeholder="code">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select_bank select @error('bank') is-invalid @enderror"
                                id='bank' name="bank">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select
                                class="form-control select_bank_branch select @error('bank_branch') is-invalid @enderror"
                                id="bank_branch" name="banck_branch"></select>
                        </div>
                    </div>
                    ...
                    <div id="accountNo" class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" maxlength="15" name="accno" value="{{ old('accno') }}"
                                class="form-control @error('accno') is-invalid @enderror" placeholder="075168023994">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="mobile" value="{{ old('mobile') }}"
                                class="form-control @error('mobile') is-invalid @enderror" placeholder="687 205 600">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="postaddress" value="{{ old('postal_address') }}"
                                class="form-control @error('postal_address') is-invalid @enderror"
                                placeholder="P O BOX 1865">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="postalcity" value="{{ old('postal_city') }}"
                                class="form-control @error('postal_city') is-invalid @enderror"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="phyaddress" value="{{ old('physical_address') }}"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="haddress" value="{{ old('haddress') }}"
                                class="form-control @error('haddress') is-invalid @enderror"
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nationalid" value="{{ old('nationalid') }}"
                                class="form-control @error('nationalid') is-invalid @enderror" placeholder="National ID">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="emp_level" value="{{ old('emp_level') }}"
                                class="form-control emp_level @error('emp_level') is-invalid @enderror"
                                placeholder="level">
                        </div>
                    </div>
                </div>
