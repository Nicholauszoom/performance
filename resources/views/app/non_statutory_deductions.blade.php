                                        ...
                                        <tr id="domain<?php echo $row->id; ?>">
                                            ...
                                            @if ($pendingPayroll == 0)
                                                <td class="options-width">
                                                    <?php $par = $row->id . '|2'; ?>
                                                    <a href="{{ route('flex.deduction_info', $par) }}" title="Info and Details"
                                                        class="icon-2 info-tooltip"><button type="button"
                                                            class="btn btn-main btn-xs"><i class="ph-info"></i></button> </a>
                                                    <a href="javascript:void(0)" onclick="deletededuction(<?php echo $row->id; ?>)"
                                                        title="Delete Deduction" class="icon-2 info-tooltip"><button
                        ...
                        @can('add-deduction')
                            ...
                            <div class="card border-top  border-top-width-3 border-top-main rounded-0 p-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="addDeduction" method="post" autocomplete="off"
                                        ...
                                        <div id="percent" class="mb-3">
                                            ...
                                            <input required id="deduction_percentf" type="number" name="rate" min="0"
                                        ...
                                        <div id="amount" class="mb-3">
                                            ...
                                            <input required id="deduction_amountf" type="number" step="any"
                                                placeholder="Fixed Amount" name="amount" class="form-control">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="currency">Currency </label>
                                            <select required name="currency" id="currency" class="select_group form-control select"
                                                data-width="1%">
