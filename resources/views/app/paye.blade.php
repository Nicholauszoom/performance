            ...
            foreach ($paye as $row) { ?>
                <tr>
                    ...
                    <td class="options-width">
                        ...
                        <a class="tooltip-demo" data-toggle="tooltip" data-placement="top" title="Edit"
                            href="<?php echo url(''); ?>/flex/paye_info/".$row->id; ?>"><button type="button"
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="card-head">
                            <h2>P.A.Y.E Ranges &nbsp;&nbsp;&nbsp;<a><button type="button" id="newPaye"
                                        data-toggle="modal" class="btn btn-main">Add New</button></a></h2>
                          ...
                          foreach ($paye as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="options-width">
                                            ...
                                            <a class="tooltip-demo" data-toggle="tooltip" data-placement="top"
                                                title="Edit" href="<?php echo url(''); ?>/flex/paye_info/".$row->id;
                  ...
                  @can('add-payee-range')
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form autocomplete="off" id="addPAYE" enctype="multipart/form-data" method="post"
                                data-parsley-validate class="form-horizontal form-label-left">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Minimum Amount
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="" type="number" min="0" max="100000000" step="1"
                                            name="minimum" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Maximum
                                        Amount
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="" type="number" min="0" max="100000000"
                                            step="1" name="maximum" class="form-control col-md-7 col-xs-12">
                                        <span class="text-danger"><?php // echo form_error("fname");
                                        ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Excess Added
                                        To an Amount Exceedint the Minimum Amount
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="" type="number" min="0" max="100000000"
                                            step="1" name="excess" class="form-control col-md-7 col-xs-12">
                                        <span class="text-danger"><?php // echo form_error("fname");
                                        ?></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Percentage
                                        Contribution to Amount that Exceed the Minimum Amount
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input required="" type="number" min="0" max="99"
                                            step="1" name="rate" class="form-control col-md-7 col-xs-12">
                                        <span class="text-danger"><?php // echo form_error("fname");
                                        ?></span>
                                    </div>
                                </div>
