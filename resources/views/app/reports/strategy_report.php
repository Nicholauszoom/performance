...
<thead>
  <tr align="center">
    ...
    <th width="350"><b>Outcome Name.</b></th>
    <th width="190" ><b>Accountable Executive</b></th>
    <th width="80" ><b>Duration</b></th>
    <th width="90" ><b>Start</b></th>
    <th width="90"><b>End</b></th>
  ...
  foreach($outcomeList as $key){
      ...
      $requiredProgress = $taskCount*100;
      if ($requiredProgress==$totalTaskProgress && $taskCount>0) $status=2; else $status = 0;
     ...
     /* if($overDue>=0){
      ...
      if($finish<$today){
        if($status ==2 ){
          $outcomeProgress = "Completed"; $color = "#00CC00"; 
        } else{ $outcomeProgress = "Overdue ".number_format($progress,1)."%"; $color = "#FF0000"; }
      }else{
        if($status==2){
          $outcomeProgress = "Completed"; $color = "#00CC00"; 
        }else{
          if($progress==0 || $taskCount==0){
            $outcomeProgress = "Not Started"; $color = "#FFA500";
          }else{
            $outcomeProgress  = "In Progress ".number_format($progress,1)."%";  $color = "#ADD8E6";
          }
        }
      }
  ...
  <tbody>
    ...
    <td width="350">&nbsp;<b>'.$strategy_ref.'.'.$id.'</b>&nbsp;'.$outcome_name.'</td>
    <td width="190" >&nbsp;'.$accountable.'</td>
    <td width="80" align="center">&nbsp;'.$DURATION.'</td>
    <td width="90" align="center">&nbsp;'.$fromDate.'</td>
    <td width="90" align="center">&nbsp;'.$toDate.'</td>
    <td width="100" align="center" bgcolor="'.$color.'" color="#000000">&nbsp;<b>'.$outcomeProgress.'</b></td>
  </tr></tbody>';
}
...
<thead>
  <tr align="center">
    <th width="37"><b>S/N</b></th>
    <th width="350"><b>Output Name</b></th>
    <th width="190" ><b>Accountable Executive</b></th>
    <th width="80"><b>Duration</b></th>
    <th width="90"><b>Start</b></th>
    <th width="90"><b>End</b></th>
  ...
  foreach($outputList as $rowOutput){
    ...
    $finishDate = date('d-m-Y', strtotime($rowOutput->end));
      ...
      if($finish<$today){
        if($status == 2 ){
          $outputProgress = "Completed"; $color = "#00CC00"; 
        } else{ $outputProgress = "Overdue ".number_format($progress,1)."%"; $color = "#FF0000"; }
      }else{
        if($status==2){
          $outputProgress = "Completed"; $color = "#00CC00"; 
        }else{
          if($progress==0 || $taskCount==0){
            $outputProgress = "Not Started"; $color = "#FFA500";
          }else{
            $outputProgress  = "In Progress ".number_format($progress,1)."%";  $color = "#ADD8E6";
          }
        }
      }
  ...
  $html .='<tbody>
      <tr nobr="true">
            <td width="37" align="center">'.$sno.'</td>
            <td width="350">&nbsp;<b>'.$strategy_ref.'.'.$outcome_ref.'.'.$id.'</b>&nbsp;'.$outputTitle.'</td>
            <td width="190" >&nbsp;'.$name.'</td>
            <td width="80">&nbsp;'.$DURATION.'</td>
            <td width="90" align="center">&nbsp;'.$startDate.'</td>
            <td width="90" align="center">&nbsp;'.$finishDate.'</td>
...
<thead>
  ...
  $html .='<tbody>
      <tr nobr="true">
            <td width="37" align="center">'.$sno.'</td>
            <td width="355">&nbsp;<b>'.$strategy_ref.'.'.$outcome_ref.'.'.$output_ref.'.'.$id.'</b>&nbsp;'.$taskTitle.'</td>
