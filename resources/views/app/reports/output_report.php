...
$pdf->SetTitle('Strategy Report_Output');
...
$pdf->SetXY(20, 55);
$headertable = "
<p><b>TRACK TO COMPLETION<br>STRATEGY NAME (OUTPUT): &nbsp;&nbsp;&nbsp;&nbsp;</b>".strtoupper($name)."<br><b>PROGRESS: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>".$totalStrategyProgress."%<br></p>";
$pdf->writeHTMLCell(0, 12, '', '', $headertable, 0, 1, 0, true, '', true);
...
<thead>
  <tr align="center">
    ...
    <th width="400"><b>Output Name</b></th>
    <th><b>Accountable Executive</b></th>
    <th width="70"><b>Duration</b></th>
  ...
  foreach($outputList as $rowOutput){
    $sno = $rowOutput->SNo;
    $outcome_name = $rowOutput->outcomeTitle;
  ...
  $html .='<tbody>
      <tr nobr="true">
            ...
            <td width="400">&nbsp;'.$outputTitle.'<br><b>Outcome Reference:</b>'.$outcome_name.'</td>
            <td>&nbsp;'.$name.'</td>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('output_report-'.date('d/m/Y').'.pdf', 'I');
