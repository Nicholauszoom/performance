        ...
        <?php if(session('mng_org')){ ?>
            <div  class="col-md-12 col-lg-12 col-sm-12 col-xs-12 ">
                ...
                <div id="positionAddFeedBack"></div>
                    ...
                    <form id="addPosition1" enctype="multipart/form-data" action="{{ route('flex.addPosition') }}"  method="post"  data-parsley-validate class="form-horizontal form-label-left">
                       @csrf
                      <!-- START -->
                      <div class="row">
