        ...
        <tbody>
          <?php
            ...
            <tr id = "recordFinanceGroup<?php echo $row->id; ?>">
              ...
              <?php if($row->type>0){ ?>
                {{-- @if($row->grouped_by == 1)  --}}
              <a  href="<?php echo  url(''); ?>/flex/financial_groups_details/?id=<?php echo base64_encode($row->id); ?>" title="Info and Details" class="icon-2 info-tooltip"><button type="button" class="btn btn-main btn-xs"><i class="ph-info"></i>By Emp</button> </a>
               {{-- @else  --}}
               <a  href="<?php echo  url(''); ?>/flex/financial_groups_byRole_details/?id=<?php echo base64_encode($row->id); ?>" title="Info and Details" class="icon-2 info-tooltip"><button type="button" class="btn btn-main btn-xs"><i class="ph-info"></i>By Role</button> </a>
               {{-- @endif --}}
