                          ...
                          <tr id="record<?php echo $row->id;?>">
                            ...
                            <td id="status<?php echo $row->id;?>">
                              ...
                              <?php if($row->state==0 && session('mng_paym')){ ?>
                                <a href="javascript:void(0)" onclick="deleteBonus(<?php echo $row->id; ?>)"  title="Delete Incentive" class="icon-2 info-tooltip"><button type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button> </a>
                                <?php }  ?>  
                            </td>
                         </tr>
                          <?php }  ?>
