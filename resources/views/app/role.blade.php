            ...
            <tr id = "recordRoleGroup<?php echo $row->id; ?>">
              ...
              <?php if( session('mng_roles_grp')){ ?>
                <td class="options-width">
                  <?php if($row->type>0){ ?>
                    <a  href="{{ route('flex.groups',['id'=>base64_encode($row->id)]) }}" title="Info and Details" class="icon-2 info-tooltip">
          ...
          // if ($department->num_rows() > 0){
            ...
            <tr id = "recordRole<?php echo $row->id; ?>">
              ...
              <td><?php echo $row->name; ?></td>
                ...
                @if ( session('mng_roles_grp') )
                <td class="options-width">
                  <a  href="{{ route('flex.role_info',['id'=>base64_encode($row->id)]) }}"  title="Info and Details" class="icon-2 info-tooltip">
                    <button type="button" class="btn btn-info btn-xs"><i class="ph-info"></i></button>
                  </a>
