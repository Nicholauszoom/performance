                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($row->amount_last_paid,2); ?>
                              <?php if($row->state==1){ ?> <div class="col-md-12"><span class="label label-danger">ACTIVE</span></div><?php } elseif($row->state==0){ ?><div class="col-md-12"><span class="label label-success">COMPLETED</span></div><?php } elseif($row->state==2){ ?><div class="col-md-12"><span class="label label-warning">PAUSED</span></div><?php } ?>
                            </td>
                            </tr>
                          <?php }  ?>
                      </tbody>
                        ...
                        <tbody>
                          <?php
                            ...
                            <tr>
                              ...
                              <td><b>Department: </b><?php echo $row->department; ?><br><b>Position: </b><?php echo $row->position; ?></td>
                              <td><?php echo $row->description; ?></td>
                              <td><?php echo number_format($row->amount,2); ?></td>
                              <td><?php echo number_format($row->paid,2); ?></td>
                              <td><?php echo number_format(($row->amount-$row->paid),2); ?></td>
                              ...
                              <a href="javascript:void(0)" onclick="resumeLoan(<?php echo $row->id;?>)">
                                  <button  class="btn btn-info btn-xs">RESUME</button></a>
                              <?php } ?>
