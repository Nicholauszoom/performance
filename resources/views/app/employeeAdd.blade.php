                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="middleName" name="mname" value="{{ old('mname') }}"
                                class="form-control @error('mname') is-invalid @enderror" maxlength="15" pattern="[a-zA-Z]+"
                                title="Only enter letters" placeholder="Middle Name">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="lname" value="{{ old('lname') }}"
                                class="form-control @error('lname') is-invalid @enderror" maxlength="15" pattern="[a-zA-Z]+"
                                title="Only enter letters" placeholder="Last Name">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select_country select @error('nationality') is-invalid @enderror"
                                name="nationality">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select_pension select @error('pension_fund') is-invalid @enderror"
                                name="pension_fund">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <select class="form-control select_bank_branch select" id="bank_branch"
                                name="bank_branch"></select>
                        </div>
                    </div>
                    ...
                    <div id="accountNo" class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" maxlength="15" name="accno" value="{{ old('accno') }}"
                                class="form-control @error('accno') is-invalid @enderror">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="mobile" value="{{ old('mobile') }}"
                                class="form-control @error('mobile') is-invalid @enderror" maxlength="14">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="postaddress" value="{{ old('postal_address') }}"
                                class="form-control @error('postal_address') is-invalid @enderror" maxlength="15">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="postalcity" value="{{ old('postal_city') }}"
                                class="form-control @error('postal_city') is-invalid @enderror" maxlength="15">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="phyaddress" value="{{ old('physical_address') }}"
                                class="form-control @error('physical_address') is-invalid @enderror" maxlength="25">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="haddress" value="{{ old('haddress') }}"
                                class="form-control @error('haddress') is-invalid @enderror" maxlength="25">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nationalid" value="{{ old('nationalid') }}"
                                class="form-control @error('nationalid') is-invalid @enderror" maxlength="150">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="tin" value="{{ old('tin') }}"
                                class="form-control @error('tin') is-invalid @enderror" maxlength="100">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="emp_level" value="{{ old('emp_level') }}"
                                class="form-control emp_level @error('emp_level') is-invalid @enderror" maxlength="30"
                                required>
                        </div>
                    </div>
                </div>
