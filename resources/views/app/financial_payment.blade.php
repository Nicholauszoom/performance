                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-keytable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php foreach ($adv_overtime as $row) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo "<b>On: </b>" . date('d-m-Y', strtotime($row->applicationDATE)) . "<br><b>Duration: </b>" . $row->totoalHOURS . " Hrs.<br><b>From: </b>" . $row->time_in . " <b> To </b>" . $row->time_out; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div id="record<?php echo $row->eoid; ?>">
                                                                <?php if ($row->status == 0) { ?>
                                                                <div class="col-md-12"><span class="badge bg-default">REQUESTED</span></div>
                                                                <?php } elseif ($row->status == 1 && $pendingPayroll == 0) { ?>
                                                                <div class="col-md-12">
                                                                    <span class="badge bg-info">RECOMENDED BY LINE MANAGER</span>
                                                                </div>
                                                                <?php } elseif ($row->status == 4 && $pendingPayroll == 0) { ?>
                                                                <div class="col-md-12">
                                                                    <span class="badge bg-success">APPROVED BY FINANCE</span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <span class="badge bg-success">APPROVED BY CD</span>
                                                                </div>
                                                            ...
                                                            <a href="javascript:void(0)" title="Approve" class="icon-2 info-tooltip" onclick="hrapproveOvertime(<?php echo $row->eoid; ?>)">
                                                            ...
                                                            <a href="javascript:void(0)" title="Recommend" class="icon-2 info-tooltip" onclick="fin_approveOvertime(<?php echo $row->eoid; ?>)">
                                                                <button class="btn btn-main btn-xs"><i class="ph-check"></i></button>
                                                            </a>
                                                            ...
                                                            <a href="javascript:void(0)" title="Approve" class="icon-2 info-tooltip" onclick="approveOvertime(<?php echo $row->eoid; ?>)">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="imprestTab" aria-labelledby="profile-tab">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="text-main">Imprests </h4>
                                    </div>
...
{{--
        ...
        <div role="tabpanel" class="tab-pane fade active show" id="incentivesTab" aria-labelledby="profile-tab">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-main">Incentives </h4>
                    </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php foreach ($incentives as $row) { ?>
                                    <?php if ($row->state == 1) { continue; } ?>
                                    <tr id="record<?php echo $row->id; ?>">
                                        <td width="1px"><?php echo $row->SNo; ?></td>
                                        <td><?php echo $row->name; ?></td>
                                        <td>Department:<?php echo $row->department; ?><br> Position:<?php echo $row->position; ?></td>
                                        ...
                                        <td id="option<?php echo $row->id; ?>">
                                            ...
                                            <a href="javascript:void(0)" onclick="confirmBonus(<?php echo $row->id; ?>)" title="Approve Incentive" class="icon-2 info-tooltip">
                                                <button type="button" class="btn btn-success btn-xs"><i class="ph-check"></i></button>
                                            </a>
                                            <?php } else if (/*session('recom_paym') && */ $row->state == 0) { ?>
                                            <a href="javascript:void(0)" onclick="recommendBonus(<?php echo $row->id; ?>)" title="Recommend Incentive" class="icon-2 info-tooltip">
