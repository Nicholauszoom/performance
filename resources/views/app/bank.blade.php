                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                      <div class="card">
                        <div class="card-head py-2">
                          ...
                          <button type="button" id="modal" data-toggle = "modal" data-target="#addBankModal" class="btn btn-main">ADD BANK</button>
                          <a href="#bottom"><button type="button" id="modal" data-toggle="modal" data-target="#departmentModal" class="btn btn-main">ADD BRANCH</button></a>
                        <?php } ?>
                          </h2>
                              ...
                              <?php
                                ...
                                <tr id="domain<?php echo $row->id;?>">
                                  ...
                                  <td class="options-width d-flex">
                                      <a href="<?php echo url('flex.updateBank')."/?category=1&id=".base64_encode($row->id); ?>" title="Info and Details" class="icon-2 info-tooltip me-2"><button type="button" class="btn btn-main btn-xs"><i class="ph-info"></i></button> </a>
                                      <a href="javascript:void(0)" onclick="deleteBank(<?php echo $row->id; ?>)" title="Delete" class="icon-2 info-tooltip"><button type="button" class="btn btn-danger btn-xs"><i class="ph-trash"></i></button> </a>
                                  </td>
                                 </tr>
                                <?php } //} ?>
                            </tbody>
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                      <div class="card">
                        ...
                        <div id="branchList" class="card-body">
                              ...
                              <?php
                                ...
                                <tr id="domain<?php echo $row->id;?>">
                                  ...
                                  <td class="options-width">
                                      <a href="<?php echo url('flex/updateBank')."/?category=2&id=".base64_encode($row->id); ?>" title="Info and Details" class="icon-2 info-tooltip"><button type="button" class="btn btn-main btn-xs"><i class="ph-info"></i></button> </a>
                                      <a href="javascript:void(0)" onclick="deleteBank(<?php echo $row->id; ?>)" title="Delete" class="icon-2 info-tooltip"><button type="button" class="btn btn-danger btn-xs"><i class="ph-trash"></i></button> </a>
                                  </td>
                                 </tr>
                                <?php } //} ?>
                    ...
                    <?php if( session('mng_bank_info')){ ?>
                     <div id="bottom" class="col-md-6 col-sm-6 col-xs-6 offset-3">
                                  
                          <div class="card">
                            <div class="card-head py-2 px-2">
                      ...
                      <div class="modal fade" id="addBankModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <!-- Modal Form -->
                                <form id="demo-form2" autocomplete="off" enctype="multipart/form-data"  method="post" action="<?php echo url('flex.addBank'); ?>addBank"  data-parsley-validate class="form-horizontal form-label-left" autocomplete="off">
