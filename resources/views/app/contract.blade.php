                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List of Current Contract
                     ...
                     &nbsp;&nbsp;&nbsp;<a><button type="button" id="insertContract" data-toggle="modal"  class="btn btn-primary">Add New Contract</button></a></h2>
                ...
                <div class="x_panel">
                  ...
                  <div id="feedBack"></div>
                    <form autocomplete="off" id="addContract" enctype="multipart/form-data"  method="post" action="<?php echo  url(''); ?>/flex/contractAdd"  data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Duration (Years)
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" min="0.5" step="0.5" required="" max="100" name="duration" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
                      
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Notify Me (Months before Contract Expiration)
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input required="" type="number" min="1" step="1" required="" max="36" name="alert" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
