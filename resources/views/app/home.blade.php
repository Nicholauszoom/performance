...
@section('content')
    ...
    <div class="row">
        <div class="@if (session('vw_emp_sum')) col-md-7 @else col-md-12 @endif">
            <div class="card">
                ...
                <div class="card-body">
                  <h6>
                    <p <?php if(session('pass_age')>84){?> style="color:red" <?php } ?>>Password Expires in <?php echo 90 - session('pass_age'); ?>
                        Days</p>
                </h6>
    ...
    <div class="card col-md-12 table-striped">
      <div class="card-header">
    ...
    {{-- <div class="right_col" role="main">
        ...
        <div class="row top_tiles">
            ...
            {{-- <div class="animated flipInY col-lg-4 col-md-3 col-sm-6 col-xs-12">
                {{-- <?php //if(session('regemp')!='' || session('line')!='' ){
                ?><a href="<?php echo url(''); ?>/flex/employee"><?php //}
                ?> 
                ...
                <div class="x_panel">
                    ...
                    <div class="row x_content">
                        ...
                        <h5><?php echo number_format($salary, 2); ?>
                            <b class="col-md-4">Basic Salaries:</b>
                        </h5>
                        ...
                        <h5><?php echo number_format($salary + $allowances, 2); ?>
                            <b class="col-md-4">Gross Salaries (Total):</b>
                        </h5>
                        ...
                        <h5><?php echo number_format($salary + $allowances + $sdl + ($salary + $allowances) * 0.01 + $pension_employer + $medical_employer, 2); ?></h5>
