    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-edit"></i>&nbsp;&nbsp;<b>Deriverables</b></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        ...
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#overtimeTab" id="home-tab" role="tab"
                                        data-toggle="tab" aria-expanded="true">Deriverables</a>
                                </li>

                                <li role="presentation" class=""><a href="#imprestTab" role="tab" id="profile-tab"
                                        data-toggle="tab" aria-expanded="false">New Derivarable</a>
                                </li>
                                                ...
                                                foreach ($deliverables as $row) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="options-width">
                                                                <a
                                                                    href="<?php echo url('flex/project/deliverableInfo?deliverableId=') . base64_encode($row->id); ?>">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="imprestTab"
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <form autocomplete="off" id="saveDeliverable"
