                      ...
                      <div class="x_content">    
                        <div class="" role="tabpanel" data-example-id="togglable-tabs">
                          <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                            ...
                            <li role="presentation" class=""><a href="#updateImprest" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false"><font class = "text-info"><i class="fa fa-edit"></i>&nbsp;&nbsp;<b>UPDATE IMPREST</b></font></a>
                            </li>
                            <?php } ?>
                            <li role="presentation" class=""><a href="#requirement_tab" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false"><font class = "text-info">&nbsp;&nbsp;<b>REQUIREMENTS</b></font></a>
                            </li>
                            <?php 
                            if($applicant == session('emp_id')){ 
                            if ($status==0 || $status==6 ){ ?>
                            <li role="presentation" class=""><a href="#add_new_requirement" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false"><font class = "text-info">&nbsp;&nbsp;<b>ADD NEW REQUIREMENTS</b></font></a>
                            </li>
                            <?php } } ?>
                          </ul>
