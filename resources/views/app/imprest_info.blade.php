                                  ...
                                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-underline nav-justified mb-3" id="tabs-target-right" role="tablist">
                                      ...
                                      <li class="nav-item" role="presentation">
                                        <a href="#description" class="nav-link active show" data-bs-toggle="tab" aria-selected="false"
                                            role="tab" tabindex="-1">
                                      ...
                                      <?php } ?>
                                      <li class="nav-item" role="presentation">
                                        <a href="#requirement_tab" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab"
                                            tabindex="-1">
                                            <i class="ph-list me-2"></i>
                                            Requirement
                                        </a>
                                          ...
                                          <div class="card">
                                            <div class="card-body">
                                              ...
                                              <form autocomplete="off" id="Update_imprestTitle" enctype="multipart/form-data"  method="post" data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                  <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3 py-2">
                                                ...
                                                <tr id="recordRequirement<?php echo $row->id;?>">
                                                  ...
                                                  if($status==0 || $status==1 || $status==6){
                                                   ...
                                                   <!-- <a href="javascript:void(0)" onclick="deleteRequirement(<?php echo $row->id;?>)"   title="Delete" class="icon-2 info-tooltip"><button class="btn btn-danger btn-xs"><i class="ph-trash-o"></i></button> </a>
                                                     -->
                                                     <?php } if($row->status==0 || $row->status==5) { ?>
                                                  <a href="javascript:void(0)" onclick="approveRequirement(<?php echo $row->id;?>)"   title="Approve" class="icon-2 info-tooltip"><button class="btn btn-success btn-xs"><i class="ph-check"></i></button> </a>
                                                  <?php } } } ?>
                                                  ...
                                                  <a href="javascript:void(0)" onclick="confirmRequirement(<?php echo $row->id;?>)"   title="Confirm" class="icon-2 info-tooltip"><button class="btn btn-main btn-xs"><i class="ph-check"></i></button> </a>
                                                  <?php }  if($row->status==1 || $row->status==2) { ?>
                                                  <a href="javascript:void(0)" onclick="unconfirmRequirement(<?php echo $row->id;?>)"   title="Unconfirm" class="icon-2 info-tooltip"><button class="btn btn-danger btn-xs"><i class="ph-x"></i></button> </a>
                                                  <?php } } 
