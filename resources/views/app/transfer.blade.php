...
<div class="card mb-3">
    <div class="card-header">
        <h6>Current Employee Tranfer</h6>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id ="status<?php echo $row->id; ?>">
                                <?php if($row->status==0){ ?> <div class="col-md-12"><span class="badge bg-secondary">WAITING</span></div><?php }
                                elseif($row->status==1){ ?><div class="col-md-12"><span class="badge bg-success">ACCEPTED</span></div><?php }
                                elseif($row->status==2){ ?><div class="col-md-12"><span class="badge bg-danger">REJECTED</span></div><?php } ?>
                            </div>
                        </td>

                        <td class="options-width">
                            <a href="<?php echo  url('') .'/flex/userprofile/?id='.$row->empID; ?>" title="Employee Info and Details" class="icon-2 info-tooltip">
...
<div class="card mb-3">
    <div class="card-header">
        <h6>Current Employee Registered</h6>
    </div>
            ...
            <?php foreach ($transfers as $row) {
                if($row->status<5 || $row->status > 5 ) continue; ?>
                    <tr>
                        ...
                        <td class="options-width">
                            <div class="d-flex">
                                <a href="<?php echo  url('').'/flex/userprofile/?id='.$row->empID; ?>" title="Employee Info and Details" class="icon-2 info-tooltip ms-2">
                                    <button type="button" class="btn btn-info btn-xs"><i class="ph-info"></i></button>
                                </a>
                                <?php if($row->status==5){ ?>
