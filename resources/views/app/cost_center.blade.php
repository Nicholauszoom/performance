    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Cost Center   
            <?php if($this->session->userdata('mng_org')){ ?><a href="#bottom"><button type="button" id="modal" data-toggle="modal" data-target="#departmentModal" class="btn btn-primary">ADD NEW</button></a> <?php } ?></h2>
            ...
            <table id="" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Name</th>
                  <th>Location</th>
                  <?php if($this->session->userdata('mng_org')){ ?>
                  <th>Option</th>
                  <?php } ?>
                </tr>
              </thead>
                ...
                <?php
                  ...
                  <tr id="domain<?php echo $row->id;?>">
                    ...
                    <a title="Update" class="icon-2 info-tooltip"><button type="button" id="modal" data-toggle="modal" data-target="#updateModal<?php echo $row->id; ?>" class="btn btn-info btn-xs"> <i class="fa fa-edit"></i></button></a>
                        ...
                        <a href="<?php echo base_url()."index.php/cipay/company_branch_info/?id=".base64_encode($row->id); ?>" title="Info and Details" class="icon-2 info-tooltip"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-info-circle"></i></button> </a>
                        ...
                        <div class="modal fade" id="updateModal<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <!-- Modal Form -->
                                  <form id="demo-form2" enctype="multipart/form-data"  method="post" action="<?php echo base_url(); ?>index.php/cipay/updateCostCenter"  data-parsley-validate class="form-horizontal form-label-left">
...
<script type="text/javascript">
  $('#addCostCenter').submit(function(e){
      e.preventDefault(); 
           $.ajax({
               url:"<?php echo base_url(); ?>index.php/cipay/addCostCenter",
               type:"post",
