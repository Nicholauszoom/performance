...
<body class="bg-white">
            ...
            <div class="content-inner">
                <div class="content d-flex justify-content-center align-items-center">
                    ...
                    <form action="{{ route('password.update') }}" method="POST" class="login-form" autocomplete="off">
                        ...
                        <div
                            class="card border-top border-bottom border-bottom-width-3 border-top-width-3 border-top-main border-bottom-main rounded-0mb-0">
                            ...
                            <div class="card-body">
                                <div class="text-center mb-3">
                                    ...
                                    @if ($brandSetting->dashboard_logo)
                                        <img src="{{ asset('storage/' . $brandSetting->dashboard_logo) }}"
                                            alt="flex logo" style="height: 10em" class="img-fluid">
                                    @else
                                        <img src="{{ asset('assets/images/hc-hub-logo2.png') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-control-feedback form-control-feedback-start">
                                        <input class="form-control @if ($errors->has('current_password')) is-invalid @endif"
                                ...
                                <div class="mb-3">
                                    <label class="form-label text-main" for="password_confirmation">Confirm
                                        Password</label>
    ...
    <div class="mb-2">
        ...
        @if ($brandSetting->company_logo)
            <img src="{{ asset('storage/' . $brandSetting->company_logo) }}" class=" float-end"
