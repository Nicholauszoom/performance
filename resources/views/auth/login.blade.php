...
<head>
    ...
    <style>
    .login-cover {
        background-image: url('{{ asset('img/new-pf-01.jpg') }}');
        /* height: 100%; */
                ...
                <div class="content d-flex align-items-center walpic">
                    ...
                    <div class="col-md-7 col-12 offset-2">
                        <div class="rounded-0 mb-0">
                            ...
                            <div  class="col-md-5  border-top  border-top-width-3 border-bottom border-bottom-main  border-bottom-width-3 border-top-main rounded-0" style="background: #ffffff8e">
