                        ...
                        <div class="card h-sm-100 mb-sm-0" style="background: #fff !important">
                            ...
                            <ul class="list-group list-group-flush ">
                                ...
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="ms-auto fw-semibold"> {{ number_format($leaveBalance, 2) }} </div>
                                </li>
                            </ul>
                        ...
                        <div class="card h-sm-100 mb-sm-0" style="background: #fff !important">
                            ...
                            <ul class="list-group list-group-flush ">
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="ms-auto fw-semibold">{{ number_format($salary, 2) }}</div>
                                </li>
                                <li class="list-group-item d-flex">
                                ...
                                <li class="list-group-item d-flex">
                                    ...
                                    @endif
                                    <div class="ms-auto fw-semibold">{{ number_format($row->amount / $rate, 2) }}</div>
                                </li>
                        ...
                        <div class="card  h-sm-100 mb-sm-0" style="background: #fff !important">
                            ...
                            <ul class="list-group list-group-flush ">
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="ms-auto fw-semibold">{{ number_format($taxdue, 2) }}</div>
                                </li>
                                <li class="list-group-item d-flex">
                                    <span class="text-muted">NSSF</span>
                                    <div class="ms-auto fw-semibold">{{ number_format($pension_employee, 2) }}</div>
                                </li>
                                @foreach ($deductions as $row)
                                    <li class="list-group-item d-flex">
                                        <span class="text-muted">{{ $row->description }}</span>
                                        <div class="ms-auto fw-semibold">{{ number_format($row->paid / $rate, 2) }}</div>
                                    </li>
                                @endforeach
                                @foreach ($loans as $row)
                                    <li class="list-group-item d-flex">
                            ...
                            <ul class="list-group list-group-flush ">
                                ...
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="ms-auto fw-semibold">
                                        {{ number_format($sum_allowances + $salary - $pension_employee, 2) }}</div>
                                </li>
                                <li class="list-group-item d-flex">
                                ...
                                @if ($total_bank_loan > 0)
                                    ...
                                    @foreach ($bank_loan as $row)
                                        <li class="list-group-item d-flex">
                                            ...
                                            <div class="ms-auto fw-semibold">{{ number_format($row->amount / $rate, 2) }}
                                            </div>
                                        </li>
                                    @endforeach
                                    <li class="list-group-item d-flex">
                                        <span class="text-muted">Total Bank Loan</span>
                                        <div class="ms-auto fw-semibold">{{ number_format($total_bank_loan / $rate, 2) }}
                                        </div>
                                    </li>
                                @endif
