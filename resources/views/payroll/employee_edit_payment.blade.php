...
<form role="form"  data-parsley-validate="" novalidate="" enctype="multipart/form-data" action="{{route('edit_payment')}}" method="post" class="form-horizontal form-groups-bordered">
        @csrf   
        <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                  <div class="">
                                    ...
                                    <input type="date" name="paid_date"   value="{{ isset($check_salary_payment) ? $check_salary_payment->paid_date : date('Y-m-d')}}"    class="salary form-control">
                                </div>
                            ...
                            if (!empty($award_info)): foreach ($award_info as $v_award_info) :
                                ...
                                <input type="hidden" name="total_award" id="total_award" value="" class="form-control">
                                      <input type="hidden" name="salary_id" id="salary_id" value="{{$check_salary_payment->id}}" class="form-control">
                                <div class="">
                                ...
                                <div class="">
                                    ...
                                    <input type="text" disabled="" value="<?php echo ($net_salary + $total_award) - $check_salary_payment->fine_deduction; ?>"
                                        class="payment_amount form-control">
                                </div>
                                <input type="hidden" name="payment_amount"
                                    value="<?php echo($net_salary + $total_award) - $check_salary_payment->fine_deduction ?>"
                                    class="payment_amount form-control">
                                <!-- Hidden Employee Id -->
                                ...
                                <div class="">
                                    ...
                                    if (!empty($all_payment_method)) {
                                        foreach ($all_payment_method as $v_payment_method) {
                                            ?>
                                        <option value="<?= $v_payment_method->id; ?>" @if(isset($check_salary_payment))@if($check_salary_payment->payment_type == $v_payment_method->id)   selected @endif @endif>
                                ...
                                <div class="mb-lg" id="postmark_config"
                                    ...
                                    <div class="">
                                        ...
                                        if (!empty($account_info)) {
                                            ...
                                            <option value="<?= $v_account->id ?>"   @if(isset($check_salary_payment))@if($check_salary_payment->account_id == $v_account->id)   selected @endif @endif>
