                    ...
                    <?php
                                ...
                                @foreach ($termination as $row2)
                                    ...
                                    <tr style="border-bottom:2px solid rgb(67, 67, 73)">
                                        ...
                                        <td class="text-end">{{ number_format(0, 2) }}</td>
                                        <td class="text-end">{{ number_format($row2->loan_balance, 2) }}</td>
                                        <td class="text-end">
                                    ...
                                    @php
                                        ...
                                        $total_wcf += round($row2->wcf,2);
                                        $total_sdl += round($row2->sdl,2);
                                        ...
                                        $total_deduction += round($row2->pension_employee + $row2->paye + $row2->otherDeductions + $row2->loan_balance,2);
