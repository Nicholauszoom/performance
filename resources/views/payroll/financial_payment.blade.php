        ...
        <div class="col-lg-12">
            ...
            <div class="border rounded p-3 mb-3">
                <ul class="nav nav-tabs nav-tabs-underline nav-justified mb-3" id="tabs-target-right" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#highlighted-justified-tab3" class="nav-link" data-bs-toggle="tab"
                            aria-selected="false" role="tab" tabindex="-1">
                            <i class="ph-at me-2"></i>
                            Imprest
                        </a>
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#highlighted-justified-tab5" class="nav-link" data-bs-toggle="tab"
                            aria-selected="false" role="tab" tabindex="-1">
                            <i class="ph-at me-2"></i>
                            Incentives
                        </a>
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#highlighted-justified-tab6" class="nav-link" data-bs-toggle="tab"
                            aria-selected="false" role="tab" tabindex="-1">
                            <i class="ph-at me-2"></i>
                            Arrears
                        </a>
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#highlighted-justified-tab7" class="nav-link" data-bs-toggle="tab"
                            aria-selected="false" role="tab" tabindex="-1">
                            <i class="ph-at me-2"></i>
                            (pending)Arrears
                        </a>
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#highlighted-justified-tab8" class="nav-link" data-bs-toggle="tab"
                            aria-selected="false" role="tab" tabindex="-1">
                            <i class="ph-at me-2"></i>
                            (all)Arrears
                        </a>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane " id="highlighted-justified-tab4" role="tabpanel">
                        4 </div>
                    <div class="tab-pane " id="highlighted-justified-tab5" role="tabpanel">
                        5 </div>
                    <div class="tab-pane " id="highlighted-justified-tab6" role="tabpanel">
                        6 </div>
                    <div class="tab-pane" id="highlighted-justified-tab7" role="tabpanel">
                        7 </div>
                    <div class="tab-pane" id="highlighted-justified-tab8" role="tabpanel">
                        8 </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="x_content">
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#payrollReportTab" id="home-tab"
                                            role="tab" data-toggle="tab" aria-expanded="true">PAYROLL</a>
                                    </li>
                                    ...
                                    <li role="presentation" class=""><a href="#incentivesTab" role="tab"
                                            id="profile-tab" data-toggle="tab" aria-expanded="false">INCENTIVES</a>
                                    </li>
                                    <li role="presentation" class=""><a href="#arrearsTab" role="tab" id="profile-tab2"
                                            data-toggle="tab" aria-expanded="false">ARREARS(Pending)</a>
                                    </li>
                                    <li role="presentation" class=""><a href="#arrearsTabPending" role="tab"
                                            id="profile-tab2" data-toggle="tab" aria-expanded="false">ARREARS(All)</a>
                                    </li>
                                    <li role="presentation" class=""><a href="#arrearsReportTab" role="tab"
                                            id="profile-tab2" data-toggle="tab" aria-expanded="false">REPORTS</a>
                                    </li>
