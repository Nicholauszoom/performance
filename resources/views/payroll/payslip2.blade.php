...
<body>
    ...
    <main>
        ...
        ?>
        <table class="table font" id="reports">
            <tfoot>

                <tr class="">
                    <td class="">
                        <div class="logo-wrapper">
                            <p style="font-weight:300 !important; ">Name: <?php echo $name; ?> </p>
                            <p style="font-weight:300 !important; ">Job Title: <?php echo $position; ?></p>
                            <p style="font-weight:300 !important; ">Location: <?php echo $branch; ?></p>
                        </div>
                    </td>
                    {{-- <td>
                            <div class="box-text text-center">
                    ...
                    <td colspan="4" class="" style="">
                        <div class="" style="text-align: right; padding-right:20px">
                            ...
                            <div>
                                <p class="" style="font-weight:300 !important; ">Payroll Number:
                                    <?php echo $employeeID; ?></p>
                                <p style="font-weight:300 !important; ">Department: <?php echo $department; ?>
                                </p>
                                <p style="font-weight:300 !important; ">Employment Date:
                                    {{ date('d-M-Y', strtotime($hiredate)) }}</p>
                            </div>
        ...
        <div class="text-center mt-2">
            <p class="fw-bold font-italic font">
