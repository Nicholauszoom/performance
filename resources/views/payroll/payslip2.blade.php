            ...
            <div class="col-md-9 mx-auto">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6 col-6">
                            <div class="row mb-1">
                                ...
                                <div class="col-md-8 col-8 bg-info">
                                    <input type="text" class="col-md-12 text-dark " disabled value="<?php echo $name; ?>" style="background-color: lightblue ;font-weight:bolder !important; "  clicked>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-9 mx-auto mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-6 col-lg-6">Net Tax </div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format($taxdue, 2); ?></div>
                            <div class="col-md-12"><hr></div>
                            <div class="col-md-6 col-6 col-lg-6">NSSF</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format($pension_employee, 2); ?></div>
                            <div class="col-md-12"><hr></div>
                            <div class="col-md-6 col-6 col-lg-6">Total Deduction</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format($pension_employee+$taxdue, 2); ?></div>
                            <div class="col-md-12"><hr></div>
                        </div>
                        <button class="col-md-12 col-12 mt-2 text-dark"  style="font-weight:bolder !important; " disabled>
                            Summary
                        ...
                        <div class="row">
                            <div class="col-md-6 col-6 col-lg-6">Total Income</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format($salary, 2) ?></div>
                            <div class="col-md-12"><hr></div>
                            <div class="col-md-6 col-6 col-lg-6">Total Deduction</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format(($pension_employee+$taxdue+$sum_deductions+$sum_loans+$meals),2); ?></div>
                            <div class="col-md-12"><hr></div>
                            <div class="col-md-6 col-6 col-lg-6">Net pay</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format($amount_takehome, 2) ?></div>
                            <div class="col-md-12"><hr></div>
                        </div>
                        <button class="col-md-12 col-12 mt-2 text-dark"  style="font-weight:bolder !important; " disabled>
                            Take Home
                        ...
                        <div class="row mx-auto" style="border-bottom: 4px solid rgb(71, 105, 116) !important; ">
                            <div class="col-md-6 col-6 col-lg-6">Take home</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo number_format($amount_takehome, 2) ?></div>
                            <div class="col-md-12"><hr></div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-md-6 col-6 col-lg-6">NSSF/PPF Number:</div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo $membership_no; ?></div>
                            <div class="col-md-6 col-6 col-lg-6">Method of Payment: </div>
                            <div class="col-md-6 col-6 col-lg-6 text-end">Bank</div>
                            <div class="col-md-6 col-6 col-lg-6">Account No: </div>
                            <div class="col-md-6 col-6 col-lg-6 text-end"><?php echo $account_no; ?></div>
                        </div>
