...
<div class="card border-top  border-top-width-3 border-top-main rounded-0">
    <div class="card-header border-0">
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 text-warning">Asses Programme Task</h5>

                <a href="{{ url('flex/view-acceleration/'.$task->acceleration_id); }}" class="btn btn-perfrom">
                    <i class="ph-list me-2"></i> All Programme Tasks
                </a>
        </div>
    <hr>
    </div>
            ...
            <div id="save_termination" class="" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form
                            action="{{ route('flex.save_acceleration_assessment') }}"
                            method="POST"
