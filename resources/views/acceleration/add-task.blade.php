@extends('layouts.vertical', ['title' => 'Add Task'])
...
<div class="card border-top  border-top-width-3 border-top-main rounded-0">
    <div class="card-header border-0">
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 text-warning">Add Programme Task</h5>

                <a href="{{ url('flex/view-acceleration/'.$project); }}" class="btn btn-perfrom">
            ...
            <div id="save_termination" class="" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form
                            action="{{ route('flex.save-acceleration-task') }}"
                            method="POST"
                        ...
                        >
                            ...
                            <div class="modal-body">
                                <div class="row mb-3">
                                    ...
                                    <input type="hidden" name="project"  class="form-control" value="{{ $project }}"  id="oldRate">

                                    <input type="hidden" name="oldSalary"  class="form-control"  id="oldsalary">
                                    <div class="col-md-6 col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">Task Name:</label>
                                            <input type="text" name="name" required id="oldLevel"   value="{{ old('emp_level') }}" class="form-control emp_level @error('emp_level') is-invalid @enderror" placeholder="Task Name">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6">
                                        <div class="mb-3">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-perfrom  btn-block mb-2 mt-2">Save Task</button>
                            </div>
                        </form>
                    </div>
                </div>
