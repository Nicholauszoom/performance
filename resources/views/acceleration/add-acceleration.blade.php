@extends('layouts.vertical', ['title' => 'New Programme'])
...
<div class="card border-top  border-top-width-3 border-top-main rounded-0">
    <div class="card-header border-0">
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 text-warning">New Programme</h5>
            ...
            <div id="save_termination" class="" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form
                            action="{{ route('flex.save-acceleration') }}"
                            method="POST"
                        ...
                        >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" id="oldLevel"   value="{{ old('emp_level') }}" class="form-control emp_level @error('emp_level') is-invalid @enderror" placeholder="Programme Name">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-perfrom  btn-block mb-2 mt-2">Save Programme</button>
                            </div>
                        </form>
                    </div>
                </div>
