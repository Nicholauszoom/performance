@extends('layouts.vertical', ['title' => 'All Accelerations'])
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card border-top  border-top-width-3 border-top-main rounded-0">
                  <div class="card-head px-3 py-1">
                    <h2>Acceleration Programmes
                    </h2>
                    <a href="{{ url('/flex/add-acceleration') }}" class="btn btn-main float-end">
                        <i class="ph-plus me-2"></i> New Programme
                      </a>
                      ...
                      <tbody>
                        @foreach($project as $item)
                            <tr>
                                ...
                                <td>
                                  @php
                                  $tasks= App\Models\AccelerationTask::where('acceleration_id',$item->id)->count();
                                  @endphp
                                ...
                                <td>
                                    <a href="{{ url('flex/view-acceleration/'.$item->id); }}" class="btn btn-sm bg-main">
                                        <i class="ph-info"></i>
                                    </a>
                                    @if ($item->status==0)
                                    ...
                                    <a href="{{ url('flex/completed-acceleration/'.$item->id); }}" class="btn btn-sm bg-success text-light">
                                        <i class="ph-check"></i>
                                    </a>
                                    @endif
