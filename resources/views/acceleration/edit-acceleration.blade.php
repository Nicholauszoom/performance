@extends('layouts.vertical', ['title' => 'Edit Programme'])
...
<div class="card border-top  border-top-width-3 border-top-main rounded-0">
    <div class="card-header border-0">
        <div class="d-flex justify-content-between">
            <h5 class="mb-0 text-warning">Edit Programme</h5>

                <a href="{{ route('flex.acceleration') }}" class="btn btn-perfrom">
                    <i class="ph-list me-2"></i> All Programmes
                </a>
        </div>
    <hr>
    </div>
            ...
            <div id="save_termination" class="" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form
                            action="{{ route('flex.update-acceleration') }}"
                            method="POST"
                        ...
                        >
                            ...
                            <div class="modal-body">
                                <div class="row mb-3">
                                    ...
                                    <input type="hidden" name="id" value="{{ $project->id }}"  class="form-control"  id="oldRate">

                                    <input type="hidden" name="oldSalary"  class="form-control"  id="oldsalary">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Programme Name:</label>
                                            <input type="text" name="name" id="oldLevel"   value="{{ $project->name }}" class="form-control emp_level @error('emp_level') is-invalid @enderror" placeholder="Project Name">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-perfrom  btn-block mb-2 mt-2">Update Project</button>
                            </div>
                        </form>
                    </div>
                </div>
