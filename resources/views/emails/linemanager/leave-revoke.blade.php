...
<head>
    ...
    <meta name="x-apple-disable-message-reformatting" />
    <link href="https://fonts.googleapis.com/css?family=Cedarville+Cursive:ital,wght@0,400" rel="stylesheet" />
    <link
        href="https://fonts.googleapis.com/css?family=Barlow:ital,wght@0,100;1,100;0,200;1,200;0,300;1,300;0,400;1,400;0,500;1,500;0,600;1,600;0,700;1,700;0,800;1,800;0,900;1,900"
        rel="stylesheet" />
    <link
        href="https://fonts.googleapis.com/css?family=Inter:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900"
        rel="stylesheet" />
    <link
        href="https://fonts.googleapis.com/css?family=Lato:ital,wght@0,100;1,100;0,300;1,300;0,400;1,400;0,700;1,700;0,900;1,900"
        rel="stylesheet" />
    <link href="https://fonts.googleapis.com/css?family=Oswald:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700"
        rel="stylesheet" />
    ...
    <style>
        @media (max-width: 620px) {
            ...
            .pc-w620-padding-30-40-40-40 {
                padding: 30px 40px 40px 40px !important;
            }

            .pc-w620-padding-0-20-0-20 {
                padding: 0px 20px 0px 20px !important;
            }

            .pc-w620-padding-20-20-10-20 {
                padding: 20px 20px 10px 20px !important;
            }

            .pc-w620-padding-30-40-30-40 {
            ...
            .pc-w620-padding-30-20-40-20 {
                padding: 30px 20px 40px 20px !important;
            }

            .pc-w620-fontSize-30px {
            ...
            table.pc-w620-spacing-0-0-26-0 {
                margin: 0px 0px 26px 0px !important;
            }

            td.pc-w620-spacing-0-0-26-0,
            th.pc-w620-spacing-0-0-26-0 {
                margin: 0 !important;
                padding: 0px 0px 26px 0px !important;
            }

            .pc-w620-padding-10-40-10-40 {
...
<body class="pc-font-alt"
    ...
    "
    bgcolor="#fefaec">
    <table class="pc-project-body" style="table-layout: fixed; min-width: 600px; background-color: #fefaec"
        bgcolor="#fefaec" width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
        <tr>
                                ...
                                <tr>
                                    <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                            role="presentation">
                                            <tr>
                                                <td valign="top" class="pc-w620-padding-20-20-10-20"
                                                    style="
                                  ...
                                  "
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top"
                                                                style="padding: 36px 0px 0px 0px">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                @if ($brandSetting->dashboard_logo)
                                                                                    <img src="{{ asset('storage/' . $brandSetting->dashboard_logo) }}"
                                                                                        ...
                                                                                        class="img-fluid">
                                                                                @else
                                                                                    <img src="https://ik.imagekit.io/7ch2jnezz/hc-hub-logo3.png?updatedAt=1704882790217"
                                                                                        alt="Logo" height="100px"
                                                                                        width="">
                                                                                @endif
                                                                                ...
                                                                                <br><br>
                                                                                <h1 style="margin-top:0;margin-bottom:1.38em;font-size:1.953em;line-height:1.3;font-weight:bold;letter-spacing:-0.02em;">Leave Revoke Request</h1>
                                ...
                                <tr>
                                    <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                            role="presentation">
                                            <tr>
                                                <td valign="top" class="pc-w620-padding-30-40-30-40"
                                                    style="
                                  ...
                                  "
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="pc-font-alt" align="left"
                                                                style="
                                          mso-line-height: exactly;
                                          line-height: 150%;
                                        ...
                                        ">
                                                                <div>
                                                                  <td style="padding:30px;background-color:#ffffff;">
                                                                    ...
                                                                    <p>This is to notify you that there is Leave request from {{ $employee_name }} to be revoked!!</p>
                                                                    <p>Please login to the system so that you can revoke.</p>
                                                                    <p>Regards,</p>
                                                                    <p>HC HUB</p>
                    ...
                    <tr>
                        <td class="pc-w620-spacing-0-0-0-0" style="padding: 0px 0px 0px 0px">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                role="presentation">
                                <tr>
                                    <td valign="top" class="pc-w620-padding-10-40-10-40"
                                        style="
                                  ...
                                  "
                                        ...
                                        <div class="text-center" style="margin-left: 80px; text-align: center; ">
