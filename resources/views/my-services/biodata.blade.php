                ...
                <div class="row">
                    <div class="col-6 mx-auto">
                        ...
                        @if ($brandSetting->company_logo)
                            <img src="{{ asset('storage/' . $brandSetting->company_logo) }}" alt="logo here"
                                width="100%">
                        @else
                ...
                <div class="card border-top border-top-width-3 p-2 border-top-main  rounded-0 border-0 shadow-none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-6 col-lg-6 col-6">
                            <h5 class="text-center bg-main" style="border: 1px solid #00204e !important;">Name Information
                            </h5>
                            <div class="row mb-1">
                        ...
                        <div class="col-md-6 col-md-6 col-lg-6 col-6">
                            <h5 class="text-center bg-main" style="border: 1px solid #00204e !important;"> Biography
                                Information</h5>
                            <div class="row mb-1">
                                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-6 col-6 col-lg-6">
                            <h5 class="text-center bg-main" style="border: 1px solid #00204e !important;">Address
                                Information</h5>
                            <div class="row mb-1">
                                <div class="col-12">
                        ...
                        <div class="col-md-6 col-md-6 col-6 col-lg-6">
                            <h5 class="text-center bg-main" style="border: 1px solid #00204e !important;"> Personal
                                Identification Information</h5>
                            <div class="row mb-1">
                                ...
                                <div class="col-6 col-md-6 col-6 col-lg-6">
                                    <p class="text-muted">
                                        {{ isset($national_id) ? $national_id : "Variable 'national_id' is not set." }}
                                    </p>
                                </div>
                                <div class="col-6 col-md-6 col-6 col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-6 col-6 col-lg-6">
                                <h5 class="text-center bg-main" style="border: 1px solid #00204e !important;">Emergency
                                    Contact Details</h5>
                                <div class="row mb-1">
                                    <div class="col-6 col-md-6 col-6 col-lg-6">
                                        <h6 class="text-main"> First Name</h6>
                            ...
                            <div class="col-md-6 col-md-6 col-6 col-lg-6 ">
                                <h5 class="text-center bg-main" style="border: 1px solid #00204e !important;"> Employment
                                    Details</h5>
                                <div class="row mb-1">
                                    <div class="col-6 col-md-6 col-6 col-lg-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-12">
                                            ...
                                            @if ($childs)
                                                <small><i>* (Birth Certificate/Adoption certificate stating you are the
                                                        legal guardian must be attached)</i></small>
            ...
            @if ($qualifications->count() > 0 || $certifications->count() > 0)
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h5 class="" style="border-bottom:4px solid #00204e !important;">EDUCATIONAL BACKGROUND:
                        </h5>
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-bordered" id="dynamicAddRemove">
                                    <tr>
                                        ...
                                        <th class="text-center">University/College/School (From highest level of education)
                                        </th>
