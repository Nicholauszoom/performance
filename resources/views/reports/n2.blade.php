                ...
                <div class="row">
                    <div class="col-md-7 col-5">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {{-- <br> --}}
                                <p>AFRICAN BANKING CORPORATION <br>P.O. BOX
                                    31<br>DAR ES SALAAM</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 col-5">
                        <h5 class="text-end font-weight-bolder" style="font-
weight:bolder;">Payroll
                ...
                <div class="row mt-4">
                    <div class="col-md-12 col-12">
                        <table class="table table-stripped " style="font-
size:14px;">
                            <thead>
                                <tr class="bg-light">
                                    <th><b>RefNo</b></th>
                            ...
                            <tbody style="border-bottom: 2px solid rgb(18, 93,
54) !important; ">
                                <tr>
                                    <td class="text-start">00001</td>
                                    <td class="text-start">Last Month Gross
                                        Salary</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-start"><b>This Month</b>
                                    </td>
                                    <td class="text-
end"><b>16,259,224</b></td>
                                    <td class="text-
end"><b>35,698,923</b></td>
                                    <td class="text-
end"><b>682,531,494</b></td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12 p-2" style="border:solid 1px gray
;border-bottom:none;">
                            <p><small>Checked By</small></p>
                            <div class="row">
                                <div class="col-md-
5">Name:__________________________</div>
                                <div class="col-md-7">Signature and
                                    Date_________________________</div>
                            </div>
                            <br>
