                <thead style="font-size:8px;">
                    ...
                    <th class=" {{ $payNo_col }} " ><b>S/N</b></th>
                        ...
                        <th class=" {{ $allowanceCat_col }} text-end" style="margin-bottom: 30px;" style="margin-bottom: 30px;"><b>{{ $row->name}}</b></th>
                        @endforeach
                    ...
                    if (!empty($summary)) {
                        ...
                        foreach ($summary as $row) {
                            if($row->currency != $currency){
                                ...
                                continue; //Skip if currency is not selected currency
                            }
