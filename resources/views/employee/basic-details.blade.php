                    ...
                    <div class="card border-top  border-top-width-3 border-top-main border-bottom-main rounded-0 p-2">
                        ...
                        <form action="{{ route('flex.saveBasicDetails') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="form-group col-6">
                                    <label class="form-label" for="">Maiden Name</label>
                    ...
                    <div class="card border-top  border-top-width-3 border-top-main border-bottom-main rounded-0 p-2">
                        ...
                        <h5 class="text-warning">Biography Information</h5>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="form-group col-6 mb-2">
                                    <label class="form-label" for="">Place of Birth</label>
                                ...
                                <div class="form-group col-12 mb-3">
                                    <label class="form-label" for="">Martial Status</label>
                                    <hr>
                                   <div class="row">
                                    <div class="col mb-2">
                                        ...
                                        <label class="form-label" for="Single">Single</label>
                                    </div>
                                    <div class="col mb-2">
                                        ...
                                        <label class="form-label" for="Married" class="pr-5">Married</label> &nbsp;
                                        <br>

                                    </div>
                                    <div class="col">
                                        <label class="form-label" for="">Marriage Date</label>
                                    ...
                                    <div class="col mb-2">
                                        ...
                                        <label class="form-label" for="Separated">Separated</label>
                                    </div>
                                    <div class="col mb-2">
                                        ...
                                        <label class="form-label" for="divorced" class="pr-5">Divorced</label> <br>
                                    ...
                                    <div class="col mb-2">
                                        ...
                                        <label class="form-label" for="widow">Widow/Widower</label><br>
                                    </div>
                                   </div>
