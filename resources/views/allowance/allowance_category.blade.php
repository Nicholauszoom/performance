            ...
            <div class="col-md-5">
                <div class="card border-top  border-top-width-3 border-top-main rounded-0 p-2">
                    ...
                    <div class="card-body">
                        ...
                        <form id="addAllowanceCategory" method="post" autocomplete="off"
        ...
        $(document).ready(function() {
            $('#addAllowanceCategory').submit(function(e) {
                ...
                $.ajax({
                        ...
                        contentType: false,
                        cache: false,
                        // async: true (removing this line as it defaults to true)
                    })
                    .done(function(data) {
                        new Noty({
                            text: 'Allowance Category Added successfully!',
                            type: 'success'
                        }).show();
                        // $('#addAllowance')[0].reset();
                    })
                    .fail(function(xhr, status, error) {
                        console.error(xhr.responseText); // Log the specific error
                        alert('FAILED, Check Your Network Connection and Try Again! ...');
                    })
                    .always(function() {
                        setTimeout(function() {
                            location.reload(); // Reload outside of AJAX completion
                        }, 2000);
                    });
            });
        });
