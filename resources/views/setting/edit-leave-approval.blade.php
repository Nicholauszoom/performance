                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-6">
                        <label class="col-form-label ">Escallation Time ( <small class="text-danger">*days</small> ) </label>
                            <input type="number" required name="escallation_time" placeholder="Enter Escallation Time"  value="{{ $approval->escallation_time }}" class="form-control @error('escallation_time') is-invalid @enderror">
