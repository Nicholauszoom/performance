...
Route::middleware('verify-outgoing-requests')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('flex/payroll')->middleware('auth')->middleware([Payroll::class])->controller(PayrollController::class)->group(function () {
            Route::any('/get_reconsiliation_summary', 'get_reconsiliation_summary')->name('payroll.get_reconsiliation_summary');
            Route::any('/get_reconsiliation_summary1', 'get_reconsiliation_summary1')->name('payroll.get_reconsiliation_summary1');
