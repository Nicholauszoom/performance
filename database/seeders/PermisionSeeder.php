...
class PermisionSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            [84, 'view-statutory-paye-report', 6],
            [85, 'view-statutory-wcf-report', 6],
            [86, 'view-statutory-pension-report', 6],
            [87, 'view-statutory-skilllevel-report', 6],
            [88, 'view-statutory-hesbl-report', 6],

            [89, 'edit-organization-report', 6],
            [90, 'view-org-reconciliation-summary', 6],
            [91, 'view-org-reconciliation-details', 6],
            [92, 'view-org-journal-entry', 6],
            [93, 'view-org-payroll-inputchange', 6],
            [94, 'view-org-pay-checklist', 6],
            [95, 'view-org-employee-biodata', 6],
            [96, 'view-org-payroll-details', 6],
            [97, 'view-org-pension-history', 6],
            [98, 'view-org-leave-report-monthly', 6],
            [99, 'view-org-leave-report-yearly', 6],
            [100, 'view-org-approved-leave-monthly', 6],
            [101, 'view-org-approved-leave-yearly', 6],
            [102, 'view-org-pending-leave-monthly', 6],
            [103, 'view-org-pending-leave-yearly', 6],

            [104, 'view-org-performance', 6],
            [105, 'view-projects-performance', 6],
            [106, 'view-dep-performance-report', 6],
            [107, 'view-acceleration-report', 6],
