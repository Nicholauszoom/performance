...
$headertable = <<<EOD
  <p align='center'><h3>EMPLOYEE SALARY ARREARS OVER TIME</h3></p>
EOD;
...
<table width = "100%">
    <tr align="left">
        <th width="180"><b>Employee ID:</b></th>
        <th width="200">'.$empID.'</th>
        <th width="180"><b>Employee Name:</b></th>
...
<thead>
  <tr style="background-color:#14141f;color:#FFFFFF;" align="center">
    ...
    <th width="110"><b>Payroll Month</b></th>
    <th width="103"><b>Expected Takehome</b></th>
    <th width="102"><b>Less Takehome</b></th>
    <th width="118"><b>Amount</b></th>
    <th width="118"><b>Paid</b></th>
    <th width="118"><b>Outstanding</b></th>
    <th width="118"><b>Last Payment</b></th>
    <th width="110"><b>Date Last<br>Payment</b></th>
  </tr>
 </thead>';
  ...
  $html .='<tbody>
      <tr nobr="true" style="background-color:'.$background.'">
            ...
            <td width="110">&nbsp;'.$payrolMonth.'</td>
            <td width="103" align="right">&nbsp;'.number_format($takehome,2).'</td>
            <td width="102" align="right">&nbsp;'.number_format($less_takehome,2).'</td>
            ...
            <td width="110"  align="center">'.$last_paid_date.'</td>
    </tr>
    </tbody>';
  ...
  $html .= '<tr colspan="8">
            <td width="147" align="center">TOTAL</td>
            <td width="103" align="right">&nbsp;'.number_format($sum_takehome,2).'</td>
            <td width="102" align="right">&nbsp;'.number_format($sum_less_takehome,2).'</td>
