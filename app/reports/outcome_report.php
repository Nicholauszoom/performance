...
$pdf->SetTitle('Strategy Report_Outcome');
...
$pdf->SetXY(20, 55);
$headertable = "
<p><b>TRACK TO COMPLETION (OUTCOME)<br>STRATEGY NAME: &nbsp;&nbsp;&nbsp;&nbsp;</b>".strtoupper($name)."<br><b>PROGRESS: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>".$progress."%<br></p>";
$pdf->writeHTMLCell(0, 12, '', '', $headertable, 0, 1, 0, true, '', true);
...
<thead>
  <tr align="center">
    ...
    <th width="300"><b>Outcome Name.</b></th>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('outcome_report-'.date('d/m/Y').'.pdf', 'I');
