...
<table border="1px">
  <tr align="center">
    ...
    <th width="70"><b>Emp ID</b></th>
    <th width="180"><b>Name.</b></th>
    <th width="140"><b>Department</b></th>
    <th><b>Position</b></th>
    <th><b>Loan Type</b></th>
    <th><b>Amount</b></th>
    <th width="90"><b>Approved On</b></th>
    <th width="70"><b>Amount Last Paid</b></th>
    <th width="90"><b>Last Paid Date</b></th>
  </tr>';
  ...
  foreach($loan as $key){
              ...
              $type = $key->TYPE;
              $amount = $key->amount;
              $date_approved = $key->approved_date_finance;
              $amount_last = $key->amount_last_paid;
              $last_paid_date = $key->last_paid_date;
  ...
  $html .='<tr>
    ...
    <td width="90">&nbsp;'.$date_approved.'</td>
    <td width="70" align="right">&nbsp;'.number_format($amount_last,2).'</td>
    <td width="90">&nbsp;'.$last_paid_date.'</td>
  </tr>';
}
