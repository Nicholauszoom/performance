...
$designation_info = Designation::where('department_id',$departments_id)->get();
                    ...
                    $employee_info =User::where('department_id',$departments_id)->where('disabled','0')->get();
                    $emp_info =User::where('department_id',$departments_id)->where('disabled','0')->get();
                    if (!empty($emp_info)) {
  ...
  $dep_name=Departments::where('id',$salary->department_id)->first();
    ...
    public function employee_salary_list()
    {
            ...
            $data = EmployeePayroll::where('disabled','0')->get();
